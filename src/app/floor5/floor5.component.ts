...
@Component({
  selector: 'app-floor5',
  standalone: false,
  templateUrl: './floor5.component.html',
  styleUrl: './floor5.component.css'
})
export class Floor5Component {
isModalOpen = false;
...
ბუნებრივი განათება`
    ...
    },
    {
      ...
      shortDescription:
        'ფუნქციური ორსაძინებლიანი ბინა მე-6 სართულზე. გამორჩეული დამატებითი ოთახით და დიდი ცენტრალური სივრცით.',
