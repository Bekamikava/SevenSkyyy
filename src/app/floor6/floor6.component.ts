...
@Component({
  selector: 'app-floor6',
  standalone: false,
  templateUrl: './floor6.component.html',
  styleUrl: './floor6.component.css'
})
export class Floor6Component {
isModalOpen = false;
...
ბუნებრივი განათება`
    ...
    },
    {
      ...
      shortDescription:
        'ფუნქციური ორსაძინებლიანი ბინა მე-7 სართულზე. გამორჩეული დამატებითი ოთახით და დიდი ცენტრალური სივრცით.',
